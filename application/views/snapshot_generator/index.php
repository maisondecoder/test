...
<head>
    ...
    <script src="<?= base_url('assets/snapshot_generator/'); ?>html2canvas.min.js"></script>
    ...
    <link href="<?= base_url('assets/snapshot_generator/'); ?>drop.css" rel="stylesheet" />
    <style>
        * {
                ...
                <div class="d-flex">
                    ...
                    <select id="logoprogram" class="form-control js-example-basic-single" aria-label="Default select example" style="width:400px">
                        ...
                        <optgroup label="Sinetron">
                            <option value="logo_aw6.png">Amanah Wali 6</option>
                            ...
                            <option value="logo_abwp.png">Aku Bukan Wanita Pilihan</option>
                            <option value="logo_top.png">Tukang Ojek Pengkolan</option>
                            <option value="logo_akujatuhcinta.png">Aku Jatuh Cinta</option>
                            <option value="logo_duyung1001.png">Putri Duyung & 1001 Keajaiban</option>
                            <option value="logo_bukancinderellabiasa.png">Bukan Cinderella Biasa</option>
                        </optgroup>
                        ...
                        <optgroup label="Lainnya">
                            ...
                            <option value="logo_abus3.png">Aku Bukan Ustad Mencari Surga</option>
                            <option value="logo_suparman.png">Suparman Reborn</option>
                            <option value="logo_crosscheck.png">Cross Check</option>
                            <option value="logo_fantasticduo.png">Fantastic Duo</option>
                            ...
                            <option value="logo_kisahviral62.png">Kisah Viral +62</option>
                            ...
                            <option value="logo_bedahrumahlagi.png">Bedah Rumah Lagi</option>
    ...
    <div class="p-5 pt-4" style="margin-bottom:100px; margin-top:30px">
        <div class="row mt-4">
            ...
            <div class="col-sm-4 col-md-3">
                ...
                <div style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/leak-bg.jpg');width:384px; height:576px;">
                    <div id="input-portrait" style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/empty.png');background-size:cover;background-position: center left;width:384px; height:576px; background-repeat:no-repeat">
                        <center>
                            <div style="width:300px;padding-top:400px">
                                <img class="logothumbnail" src="<?= base_url('assets/snapshot_generator/'); ?>logo/nologo.png" width="100%">
                            </div>
                        </center>
                    </div>
                </div>
            ...
            <div class="col-sm-8 col-md-9">
                ...
                <div style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/leak-bg.jpg');width:1000px; height:562px;">
                    <div id="input-landscape" style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/empty.png');background-size:cover;width:1000px; height:562px; background-repeat:no-repeat">
            ...
            <div class="row mt-4">
                <div class="col-sm-4 col-md-3">
                    ...
                    <div style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/leak-bg.jpg');width:384px; height:384px;">
                        <div id="input-square" style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/empty.png');background-size:cover;background-position: center left;width:384px !important; height:384px !important; background-repeat:no-repeat">
                            <center>
                                <div style="width:300px;padding-top:240px">
                                    <img class="logothumbnail" src="<?= base_url('assets/snapshot_generator/'); ?>logo/nologo.png" width="250px">
                                </div>
                            </center>
                        </div>
                    </div>
                ...
                <div class="col-sm-8 col-md-9">
                    ...
                    <div style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/leak-bg.jpg');width:1149px; height:492px;">
                        <div id="input-medium" style="background:url('<?= base_url('assets/snapshot_generator/'); ?>img/empty.png');background-size:100% auto; background-position: center;width:1149px; height:492px; background-repeat:no-repeat">
                            <div style="width:300px; float:right">
                                <img class="logothumbnail" src="<?= base_url('assets/snapshot_generator/'); ?>logo/nologo.png" width="100%">
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#logoprogram').change(function() {
            $('.logothumbnail').attr('src', '<?= base_url('assets/snapshot_generator/'); ?>logo/' + $(this).val());
        });
        ...
        function cek_nama(program) {
            var a = 0;
            var input = program;
            const namaprogram = ["seleb_on_news", "barista", "silet", "obsesi", "go_spot", "tukang_ojek_pengkolan", "anugerah_terindah", "kuraih_bintang", "anak_jalanan", "putri_untuk_pangeran", "dunia_terbalik", "ikatan_cinta", "ipa_ips", "amanah_wali_5", "cinta_anak_sholeh", "rt_kampung", "buletin_inews_pagi", "lintas_inews_pagi", "aman_wali_6", "wali_6", "bukan_wanita_pilihan", "suparman", "putri_duyung","aku_bukan_ustadz_mencari","aku_jatuh_cinta", "bukan_cinderella", "seputar_inews_pagi"];
            const logoprogram = ["logo_son.png", "logo_barista.png", "logo_silet.png", "logo_obsesi.png", "logo_gospot.png", "logo_top.png", "logo_anugerahterindah.png", "logo_kuraihbintang.png", "logo_anakjalanannb.png", "logo_pupa.png", "logo_duniaterbalik.png", "logo_ic.png", "logo_ipa.png", "logo_aw5.png", "logo_cintaanaksholeh.png", "logo_rtkampungambyar.png", "logo_bip.png", "logo_lip.png", "logo_aw6.png", "logo_aw6.png", "logo_abwp.png", "logo_suparman.png", "logo_duyung1001.png", "logo_abus3.png","logo_akujatuhcinta.png", "logo_bukancinderellabiasa.png", "logo_sip.png"];
